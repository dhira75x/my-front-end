          ...
          >
            ...
            >
              ...
              >
                <tr>
                  <td
                    class="whitespace-nowrap px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200"
                  >
                  ...
                  >
                    <div
                      class="inline-flex items-center gap-x-2 rounded-full bg-emerald-100/60 px-3 py-1 text-emerald-500 dark:bg-gray-800"
                    >
                      <svg
                        width="12"
                        height="12"
                ...
                <tr>
                  ...
                  >
                    <div
                      class="inline-flex items-center gap-x-2 rounded-full bg-red-100/60 px-3 py-1 text-red-500 dark:bg-gray-800"
                    >
                      <svg
                        width="12"
                        height="12"
                ...
                <tr>
                  ...
                  >
                    <div
                      class="inline-flex items-center gap-x-2 rounded-full bg-gray-100/60 px-3 py-1 text-gray-500 dark:bg-gray-800"
                    >
                      <svg
                        width="12"
                        height="12"
