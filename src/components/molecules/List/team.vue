          ...
          >
            ...
            >
              ...
              >
                <tr>
                  <td
                    class="whitespace-nowrap px-4 py-4 text-sm font-medium text-gray-700"
                  >
                  ...
                  <td
                    class="whitespace-nowrap px-12 py-4 text-sm font-medium text-gray-700"
                  >
                    <div
                  ...
                  <td
                    class="whitespace-nowrap px-4 py-4 text-sm text-gray-500 dark:text-gray-300"
                  >
                    Design Director
                  </td>
                  <td
                  ...
                  <td class="whitespace-nowrap px-4 py-4 text-sm">
                    <div class="flex items-center gap-x-2">
                      <p
                        class="rounded-full bg-indigo-100/60 px-3 py-1 text-xs text-indigo-500 dark:bg-gray-800"
                      >
                        Design
                      </p>
                      <p
                        class="rounded-full bg-blue-100/60 px-3 py-1 text-xs text-blue-500 dark:bg-gray-800"
                      >
                        Product
                      </p>
                      <p
                        class="rounded-full bg-pink-100/60 px-3 py-1 text-xs text-pink-500 dark:bg-gray-800"
                      >
                        Marketing
                      </p>
                    </div>
                  ...
                  <td class="whitespace-nowrap px-4 py-4 text-sm">
                    <div class="flex items-center gap-x-6">
                      <button
                        class="text-gray-500 transition-colors duration-200 hover:text-red-500 focus:outline-none dark:text-gray-300 dark:hover:text-red-500"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
