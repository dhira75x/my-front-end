<template>
  <div
    class="w-full max-w-sm p-6 mt-20 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800 justify-center place-content-center"
  >
    ...
    <form class="mt-6">
      <div>
        <label for="username" class="block text-sm text-gray-800 dark:text-gray-200"
          >Username</label
        >
        <input
          type="text"
