<template>
  <section class="container mx-auto px-4">
    ...
    <div class="mt-6 md:flex md:items-center md:justify-between">
      ...
      >
        <button
          class="bg-gray-100 px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 sm:text-sm dark:bg-gray-800 dark:text-gray-300"
        >
          View all
        </button>
    ...
    <div
      class="mt-6 flex h-96 items-center rounded-lg border text-center dark:border-gray-700"
    >
      <div class="mx-auto flex w-full max-w-sm flex-col px-4">
        ...
        <div class="mt-4 flex items-center gap-x-3 sm:mx-auto">
          <button
            class="w-1/2 rounded-lg border bg-white px-5 py-2 text-sm text-gray-700 transition-colors duration-200 hover:bg-gray-100 sm:w-auto dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
          >
            Clear Search
          </button>
