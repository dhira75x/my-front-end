...
const heroImages = ref([
  {
    url: "https://images.unsplash.com/photo-1602880329034-f2fe899a5cfd?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80",
    alt: "Electronics"
  },
  {
    url: "https://images.unsplash.com/photo-1556740749-887f6717d26e?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80",
    alt: "Fashion"
  },
  {
...
const summerImages = ref([
  ...
  {
    url: "https://images.unsplash.com/photo-1560343090-f0406e4a4b1a?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80",
    alt: "Summer Accessories"
  },
  {
    url: "https://images.unsplash.com/photo-1490474418585-ba9bad8fd0ea?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80",
    alt: "Summer Sports"
  }
]);
...
const startSummerAutoplay = () => {
  summerAutoplayInterval = setInterval(() => {
    nextSummerSlide();
  }, 4000);
};

const stopSummerAutoplay = () => {
  clearInterval(summerAutoplayInterval);
};
