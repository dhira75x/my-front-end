  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
    ...
    <div class="relative z-10 w-full max-w-6xl">
      <div class="flex flex-col md:flex-row bg-white rounded-2xl shadow-xl overflow-hidden">
        <!-- Left Panel -->
        <div
          class="w-full md:w-1/2 bg-gradient-to-br from-lime-600 to-green-800 p-8 md:p-12 flex flex-col justify-between relative overflow-hidden">
          <!-- Decorative pattern -->
          ...
          <div class="max-w-md mx-auto w-full">
            ...
            <form @submit.prevent="resetPassword" class="space-y-6">
              <div>
                ...
                <div class="relative">
                  <input v-model="reset.new_password" id="newPassword" :type="showNewPassword ? 'text' : 'password'"
              ...
              <div>
                ...
                <div class="relative">
                  <input v-model="reset.confirm_password" id="confirmPassword"
                ...
                <ul class="space-y-2">
                  <li class="flex items-center">
                    <div :class="['w-5 h-5 rounded-full flex items-center justify-center mr-2',
                      ...
                      <svg v-if="reset.new_password.length >= 8" class="w-3 h-3 text-white" fill="none"
                  ...
                  <li class="flex items-center">
                    <div :class="['w-5 h-5 rounded-full flex items-center justify-center mr-2',
                      ...
                      <svg v-if="hasUppercase" class="w-3 h-3 text-white" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                  ...
                  <li class="flex items-center">
                    <div :class="['w-5 h-5 rounded-full flex items-center justify-center mr-2',
                      ...
                      <svg v-if="hasLowercase" class="w-3 h-3 text-white" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                  ...
                  <li class="flex items-center">
                    <div :class="['w-5 h-5 rounded-full flex items-center justify-center mr-2',
                      ...
                      <svg v-if="hasSpecialCharacter" class="w-3 h-3 text-white" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
              ...
              <div v-if="reset.confirm_password" class="flex items-center">
                <div :class="['w-5 h-5 rounded-full flex items-center justify-center mr-2',
                  ...
                  <svg v-if="reset.new_password === reset.confirm_password" class="w-3 h-3 text-white" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  </svg>
